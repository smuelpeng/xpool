...
class MSRVTTABRDataset(Dataset):
    """
    ...
    def __init__(self, config: Config, split_type = 'train', img_transforms=None):
        ...
        cap_file = 'data/MSRVTT/MSRVTT_ABR_caption.json'
        ...
        self.frame_caps = load_json(cap_file)
    ...
    def __getitem__(self, index):
        ...
        frame_caption = self.frame_caps[video_id]
        ...
        return {
            'video_id': int(video_id.split('video')[-1]),
            'video': imgs,
            'text': caption,
